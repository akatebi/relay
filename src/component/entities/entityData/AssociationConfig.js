...
// const debug = require('debug')('app:component:entities:AssociationConfig');

class AssociationConfig extends Component {
  ...
  componentWillMount = () => {
    ...
    // debug('assoc cfg customProperties', window.pretty(customProperties));
...
export default createFragmentContainer(AssociationConfig, {
  entity: graphql`
    fragment AssociationConfig_entity on Entity {
      id
      label
      entityType
      reportingKey
  ...
  `,
  identity: graphql`
    fragment AssociationConfig_identity on Identity {
      ...IdentityHeader_identity
    }
  `,
  valueVMOptions: graphql`
    fragment AssociationConfig_valueVMOptions on ValueVMOptions {
      ...PropertyContent_valueVMOptions
    }
  `,
  valueVMTypeOptions: graphql`
    fragment AssociationConfig_valueVMTypeOptions on ValueVMTypeOptions {
